...
function AppContent() {
  ...
  // Update handleTabChange to use navigation
  const handleTabChange = (path: string | null) => {
    navigate(path || '/');
    window.scrollTo(0, 0);
    document.documentElement.scrollTop = 0;
    document.body.scrollTop = 0;
          ...
          <div className="max-w-6xl mx-auto px-6 flex items-center justify-between flex-wrap">
            ...
            <div className="flex gap-4">
              {[
                ...
                { id: 'submit', label: 'Submit Book', path: '/submit' },
                ...
                <Link
                  ...
                  className={`px-6 py-2 rounded-full font-cinzel text-base text-blue-200 
                    magical-button bloom ${location.pathname === tab.path ? 'active-nav-button' : ''}`}
                >
                  {tab.label}
                </Link>
              ))}
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-1 font-cormorant">
                <li><Link to="/" className="text-blue-100 hover:text-blue-300">Home</Link></li>
                <li><Link to="/books" className="text-blue-100 hover:text-blue-300">Books</Link></li>
                <li><Link to="/submit" className="text-blue-100 hover:text-blue-300">Submit Manuscript</Link></li>
                <li><Link to="/about" className="text-blue-100 hover:text-blue-300">About Us</Link></li>
              </ul>
            </div>
            <div>
